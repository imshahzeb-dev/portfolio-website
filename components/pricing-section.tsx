          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {pricingPlans.map((plan) => (
              <div key={plan.id} className="relative pricing_section">
                <div className="px-4 lg:px-8 py-5 lg:py-10 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-xl transition-all">
                  <div className="price_icon bg-gray-100 dark:bg-gray-800 w-20 h-20 flex justify-center items-center mb-3 md:mb-6 rounded-lg">
                    <i
                      className={`ph-fill ${plan.icon} text-5xl text-blue-500`}
                    ></i>
                  </div>
                  ...
                  <button className="bg-blue-500 hover:bg-blue-600 text-white text-lg w-full rounded-full py-2 md:py-4 transition-all">
                    Get Started
                  </button>
                </div>
                {plan.popular && (
                  <div className="absolute top-5 right-0 bg-orange-500 px-3 py-2 sm:px-5 sm:py-4 text-white rounded-l-lg">
                    Popular Choice
                  </div>
                )}
              </div>

...
/**
 * Cursor-following glow, tinted with the theme's primary blue.
 * Ported from the reference repo. Attaches to its parent element.
 */
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-[radial-gradient(circle_at_center,rgba(0,89,232,0.22),rgba(0,89,232,0.10)_40%,transparent_80%)]",
